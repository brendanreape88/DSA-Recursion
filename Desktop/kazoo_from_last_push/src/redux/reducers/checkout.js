...
const UPDATE_GIFT_MESSAGE = 'UPDATE_GIFT_MESSAGE';
const UPDATE_GIFT_WRAPPING = 'UPDATE_GIFT_WRAPPING';
const UPDATE_GIFT_VIDEO = 'UPDATE_GIFT_VIDEO';
const UPDATE_GIFT_THUMBNAIL = 'UPDATE_GIFT_THUMBNAIL';
...
export const updateGiftWrapping = (data) => ({
  type: UPDATE_GIFT_WRAPPING,
  data,
});
...
export const updateGiftVideo = (data) => ({
  type: UPDATE_GIFT_VIDEO,
  data,
});

export const updateGiftThumbnail = (data) => ({
  type: UPDATE_GIFT_THUMBNAIL,
  data,
});
...
export const checkout = (state = checkoutInitialState, action) => {
  switch (action.type) {
    ...
    case UPDATE_GIFT_WRAPPING:
      return {
        ...state,
        giftWrapping: action.data,
      };

    case UPDATE_GIFT_VIDEO:
      return {
        ...state,
        giftVideo: action.data,
      };

    case UPDATE_GIFT_THUMBNAIL:
      return {
        ...state,
        giftThumbnail: action.data,
      };
